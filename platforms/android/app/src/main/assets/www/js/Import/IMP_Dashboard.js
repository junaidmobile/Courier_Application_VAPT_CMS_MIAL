...
function RedirectPage(pagename) {
    ...
    if (pagename == 'IMP_Location.html' && window.localStorage.getItem("RoleIMPBinning") == '0') {
        $.alert('You are not authorized to view this page.');
        return;
    }
    else if (pagename == 'IMP_Location.html')
    ...
    if (pagename == 'IMP_GenerateBarcode.html' && window.localStorage.getItem("RoleIMPRePrint") == '0') {
        $.alert('You are not authorized to view this page.');
        return;
    }
