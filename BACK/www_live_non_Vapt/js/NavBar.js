...
(function () {
    ...
    $(".dropdown-menu").on('click', 'li', function () {
        ...
        if ($(this).text() == 'Segregation Report' && window.localStorage.getItem("RoleIMPSegregation") == '0') {
            $.alert('You are not authorized to view this page');
            return false;
        }        

        if ($(this).text() == 'Location' && window.localStorage.getItem("RoleIMPBinning") == '0') {
            $.alert('You are not authorized to view this page');
            return false;
        }        
        ...
        if ($(this).text() == 'Re-Print Package ID' && window.localStorage.getItem("RoleIMPRePrint") == '0') {
            $.alert('You are not authorized to view this page');
            return false;
        }
